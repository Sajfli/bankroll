    ...
    return (
        <ArticleNoParse type="stage">
            ...
            <ul>
                ...
                <li>
                    <p>
                        <strong>Komunikator internetowy Messenger</strong> -
                        dostępny pod{' '}
                        <a
            ...
            <ul>
                <li>
                    w przypadku rejestracji przy użyciu portali
                    społecznościowych, za wyrażoną świadomą zgodą tych osób, z
            ...
            <p>
                ...
                <br />
                <small>
                    (Np. imię i nazwisko, adres e-mail, adres IP, itp.)
                </small>
            </p>
            <p>
            ...
            <ul>
                <li>
                    ...
                    na ochronie naszych praw, w tym między innymi;
                </li>
            ...
            <p>
                ...
                przez okres świadczenia usługi w ramach prowadzonego serwisu
                przez Administratora. Są one usuwane lub anonimizowane w okresie
                do{' '}
            ...
            <ul>
                <li>
                    <p>
                        ...
                        swoich danych osobowych, realizowane na żądanie złożone
                        do Administratora
                    </p>
                </li>
                <li>
                ...
                <li>
                    <p>
                        ...
                        <br />
                        <br />W przypadku kont użytkowników, usunięcie danych
                        polega na usunięciu danych z serwera.
                        <br />
