        ...
        <ArticleNoParse type="stage">
            ...
            <ul>
                ...
                <li>
                    ...
                    "szymonjez.pl", działających pod adresem
                    https://szymonjez.pl
                </li>
                <li>
                    <strong>Usługodawca</strong> – właściciel serwisu będący
                    osobą fizyczną - Szymon Jeż
                </li>
                <li>
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            urządzenie z wyświetlaczem umożliwiające
                            wyświetlanie stron internetowych,
                        </li>
                        <li>połączenie z internetem,</li>
                        <li>
                            dowolna przeglądarka internetowa, która wyświetla
                            strony internetowe zgodnie ze standardami i
                            postanowieniami Konsorcjum W3C i obsługuje strony
                            www udostępniane w języku HTML5,
                        </li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            bez zgody pisemnej, powodujących nadmierne
                            obciążenie serwera Serwisu,
                        </li>
                        <li>
                        ...
                        <li>
                            podejmowania prób wgrywania lub wszczykiwania na
                            serwer i do bazy danych kodu, skryptów i
                            oprogramowania mogących wyrządzić szkodę
                            oprogramowaniu Serwisu, innym Usługobiorcom lub
                            Usługodawcy,
                        </li>
                        <li>
                            podejmowania prób wgrywania lub wszczykiwania na
                            serwer i do bazy danych kodu, skryptów i
                            oprogramowania mogących śledzić lub wykradać dane
                        ...
                        <li>
                            ...
                            uniemożliwienie realizacji celu w jakim działa
                            Serwis.
                        </li>
                    </ul>
                </li>
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            posiadanie indywidualnego konta na platformie
                            Facebook
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            Zabrania się Usługobiorcom zarejestrowanym w
                            Serwisie do udostępniania loginu oraz hasła do
                            swojego konta osobom trzecim.
                        </li>
                        <li>
                            Usługodawca nie ma prawa i nigdy nie będzie zażądać
                            od Usługobiorcy hasła do wybranego konta.
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            Usługobiorcy mogą to uczynić po zalogowaniu się w
                            panelu w Serwisie.
                        </li>
                        <li>
                            Usunięcie konta skutkuje usunięciem wszelkich danych
                            użytkownika z serwera
                        </li>
                    </ul>
                </li>
            </ul>
            <h2>
                V. Warunki komunikacji i świadczenia pozostałych usług w
                Serwisie
            </h2>
            <ul>
                <li>
                    ...
                    <a href="https://szymonjez.pl/polityka-prywatnosci/">
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            ...
                            obraźliwych lub oszczerczych względem Usługodawcy,
                            pozostałych Usługobiorców, osób trzecich oraz
                            podmiotów trzecich,
                        </li>
                        <li>
                            Zabrania się umieszczania w Serwisie materiałów
                            tekstowcyh, graficznych, audiowizualnych, skryptów,
                            programów i innych utworów, na które Usługobiorca
                            nie posiada się licencji, lub których autor praw
                            majątkowych nie wyraził zgody na darmową publikację,
                        </li>
                        <li>
                            Zabrania się umieszczania w Serwisie treści
                            wulgarnych, pornograficznych, erotycznych i
                            niezgodnych z polskim i europejskim prawem a także
                        ...
                        <li>
                            ...
                            oprogramowania nielegalnego, oprogramowania
                            służącego do naruszania zabezpieczeń oraz innych
                            podobnych działań a także odnośników do stron
                            zawierających wskazane materiały,
                        </li>
                        <li>
                            Zabrania się umieszczania w Serwisie treści
                            merketingowych i reklamujących inne serwisy
                            komercyjne, produkty, usługi czy komercyjne strony
                            internetowe
                        </li>
                    </ul>
                </li>
            ...
            <p>
                ...
                Usługodawca za pośrednictwem Serwisu gromadzi i przetwarza
                niektóre dane o Użytkownikach.
            </p>
            <p>
            ...
            <p>
                ...
                <Link to="/RODO">Obowiązek informacyjny RODO</Link>” oraz w „
            ...
            <ul>
                <li>
                    ...
                    <p>
                        ...
                        identyfikator Usługobiorcy powiązany z kontem
                        Usługobiorcy
                    </p>
                </li>
            </ul>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <a
                                ...
                                rel="noreferrer"
                            >
                                kontakt dostępny pod tym linkiem
                            </a>
                        </li>
                    </ul>
