    ...
    return (
        <ArticleNoParse type="stage">
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        imię i nazwisko, numer identyfikacyjny, dane o
                ...
                <li>
                    <p>
                        ...
                        zautomatyzowanego przetwarzania danych osobowych, które
                        polega na wykorzystaniu danych osobowych do oceny
                        niektórych czynników osobowych osoby fizycznej, w
                        szczególności do analizy lub prognozy aspektów
                ...
                <li>
                    <p>
                        ...
                        dotyczą oznacza dobrowolne, konkretne, świadome i
                ...
                <li>
                    <p>
                        ...
                        oznacza naruszenie bezpieczeństwa prowadzące do
                ...
                <li>
                    <p>
                        ...
                        danych osobowych w taki sposób, by nie można ich było
                        już przypisać konkretnej osobie, której dane dotyczą,
                        bez użycia dodatkowych informacji, pod warunkiem że
                ...
                <li>
                    <p>
                        ...
                        lub powiązanie danego rekordu z konkretnym użytkownikiem
                        lub osobą fizyczną.
                    </p>
                </li>
            </ul>
            ...
            <p>
                ...
                osobowych, należy kontaktować się bezpośrednio z
                Administratorem.
            </p>
            ...
            <ul>
                <li>
                    <p>
                        <strong>Cookies wewnętrzne</strong> - pliki zamieszczane
                ...
                <li>
                    <p>
                        ...
                        konfiguracja Urządzenia Użytkownika jest ustawiona na
                        tryb usuwanie plików Cookie po zakończeniu sesji
                        Urządzenia.
                    </p>
                </li>
            </ul>
            ...
            <ul>
                <li>
                    <p>
                        ...
                        mechanizmy przeglądarek internetowych i nie pozwalają na
                        pobieranie innych danych z Urządzenia Użytkownika lub
                        danych innych witryn internetowych, które odwiedzał
                        Użytkownik, w tym danych osobowych ani informacji
                        poufnych. Przeniesienie na Urządzenie Użytkownika
                ...
                <li>
                    <p>
                        ...
                        Użytkowników i nie zawierają skryptów, treści lub
                        informacji mogących zagrażać bezpieczeństwu danych
                ...
                <li>
                    <p>
                        ...
                        dokonuje wszelkich możliwych działań w celu weryfikacji
                        i doboru partnerów serwisu w kontekście bezpieczeństwa
                        Użytkowników. Administrator do współpracy dobiera
                        znanych, dużych partnerów o globalnym zaufaniu
                        społecznym. Nie posiada on jednak pełnej kontroli nad
                        zawartością plików Cookie pochodzących od zewnętrznych
                        partnerów. Za bezpieczeństwo plików Cookie, ich
                        ...
                        odpowiedzialności na tyle na ile pozwala na to prawo.
                        Lista partnerów zamieszczona jest w dalszej części
                    ...
                    <ul>
                        <li>
                            <p>
                                ...
                                zapisywania, usuwania oraz dostępu do danych
                                zapisanych plików Cookies przez każdą witrynę
                                internetową
                            </p>
                        </li>
                        <li>
                            ...
                            <ul>
                                <li>
                                    ...
                                    >
                                        Zarządzanie plikami cookies w
                                        przeglądarce <strong>Chrome</strong>
                                    </a>
                                </li>
                                <li>
                                    <a
                                    ...
                                    >
                                        Zarządzanie plikami cookies w
                                        przeglądarce <strong>Opera</strong>
                                    </a>
                                </li>
                                <li>
                                    <a
                                    ...
                                    >
                                        Zarządzanie plikami cookies w
                                        przeglądarce <strong>FireFox</strong>
                                    </a>
                                </li>
                                <li>
                                    <a
                                    ...
                                    >
                                        Zarządzanie plikami cookies w
                                        przeglądarce <strong>Edge</strong>
                                    </a>
                                </li>
                                <li>
                                    <a
                                    ...
                                    >
                                        Zarządzanie plikami cookies w
                                        przeglądarce <strong>Safari</strong>
                                    </a>
                                </li>
                                <li>
                                    <a
                        ...
                        <li>
                            <p>
                                Użytkownik może w dowolnym momencie usunąć
                                wszelkie zapisane do tej pory pliki Cookie
                                korzystając z narzędzi Urządzenia Użytkownika,
                                za pośrednictwem którego Użytkownik korzysta z
                                usług Serwisu.
                            </p>
                        </li>
                    </ul>
                ...
                <li>
                    <p>
                        ...
                        Administrator stosuje wszelkie możliwe środki techniczne
                        w celu zapewnienia bezpieczeństwa danych umieszczanych w
                        plikach Cookie. Należy jednak zwrócić uwagę, że
                        zapewnienie bezpieczeństwa tych danych zależy od obu
                        stron w tym działalności Użytkownika. Administrator nie
                        bierze odpowiedzialności za przechwycenie tych danych,
                        podszycie się pod sesję Użytkownika lub ich usunięcie,
                        na skutek świadomej lub nieświadomej działalność
                        Użytkownika, wirusów, koni trojańskich i innego
                ...
                <li>
                    <p>
                        ...
                        Użytkowników były bezpieczne, dostęp do nich był
                        ograniczony i realizowany zgodnie z ich przeznaczeniem i
                        celami przetwarzania. Administrator zapewnia także, że
                        dokonuje wszelkich starań w celu zabezpieczenia
            ...
            <ul>
                <li>
                    ...
                    <ul>
                        <li>
                            Usługi rejestracji i utrzymania konta Użytkownika w
                            Serwisie i funkcjonalności z nim związanych
                        </li>
                    </ul>
                </li>
                <li>
                    Komunikacji Administratora z Użytkownikami w sprawach
                    związanych z Serwisem oraz ochrony danych
                </li>
                <li>
            ...
            <ul>
                <li>Remarketing</li> <li>Obsługi programów afiliacyjnych</li>
                <li>
                    Zapewnienia prawnie uzasadnionego interesu Administratora
                </li>
            </ul>
            ...
            <p>
                ...
                warunki świadczenia usług, polityki prywatności, cel
            ...
            <p>
                ...
                osobowe podane dobrowolnie przez Użytkowników w trakcie
                zapisywania się do poszczególnych usług oferowanych przez
                Serwis.
            </p>
            <p>
            ...
            <p>
                ...
                przechowywana w plikach cookies. Cześć danych (bez danych
                identyfikujących) może być przekazywana do dostawcy usług
                statystycznych.
            </p>
            <h2 style={{ textAlign: 'center' }}>
            ...
            <p>
                ...
                świadczonych usług nie są przekazywane ani odsprzedawane
                podmiotom trzecim.
            </p>
            <p>
            ...
            <p>
                ...
                wskutek prac serwisowych realizowanych przez personel
                usługodawcy. Dostęp do tych danych reguluje umowa zawarta
            ...
            <ul>
                <li>
                    ...
                    chyba że zostały opublikowane na skutek indywidualnego
                    działania Użytkownika (np. wprowadzenie komentarza lub
                    wpisu), co sprawi, że dane będą dostępne dla każdej osoby
            ...
            <ul>
                <li>
                    Dane anonimiwe (bez danych osobowych) nie będą przekazywane
                    ...
                    <ul>
                        <li>
                            ...
                            <small>
                                ...
                                przetwarzanie swoich danych osobowych w jednym
                        ...
                        <li>
                            ...
                            <small>
                                ...
                                lub do podjęcia działań na żądanie osoby, której
            ...
            <p>
                ...
                zarejestrowanego konta użytkownika, wypisanie z listy
                Newsletter, itp.)
            </p>
            <p>
            ...
            <h2 style={{ textAlign: 'center' }}>
                §13 Prawa Użytkowników związane z przetwarzaniem danych
                osobowych
            </h2>
            <p>Serwis gromadzi i przetwarza dane Użytkowników na podstawie:</p>
            <ul>
                <li>
                    <p>
                        ...
                        swoich danych osobowych, realizowane za pośrednictwem
                        panelu użytkownika dostępnego po zalogowaniu i narzędzi
                ...
                <li>
                    <p>
                        ...
                        nieprawidłowe lub / oraz uzupełnienia niekompletnych
                ...
                <li>
                    <p>
                        ...
                        przetwarzania danych osobowych w przypadkach wskazanych
                        w art. 18 RODO, m.in. kwestionowania prawidłowość danych
                ...
                <li>
                    <p>
                        ...
                        Administratora, danych osobowych dotyczących Użytkownika
                        w ustrukturyzowanym, powszechnie używanym formacie
                        nadającym się do odczytu maszynowego, realizowane na
                ...
                <li>
                    <p>
                        ...
                        <br />
                        Użytkownikom przysługuje prawo wniesienia sprzeciwu
                        wobec przetwarzania jego danych osobowych w przypadkach
                        określonych w art. 21 RODO, realizowane na żądanie
            ...
            <ul>
                <li>
                    <p>
                        ...
                        Urządzeniu Użytkownika może spowodować nieprawidłowe
            ...
            <p>
                ...
                Użytkowników mogą znajdować się odnośniki do witryn
                zewnętrznych, z którymi Właściciel serwisu nie współpracuje.
                Linki te oraz strony lub pliki pod nimi wskazane mogą być
                niebezpieczne dla Twojego Urządzenia lub stanowić zagrożenie
            ...
            <ul>
                <li>
                    <p>
                        ...
                        niniejszej Polityki Prywatności bez konieczności
                        informowania o tym Użytkowników w zakresie stosowania i
                        wykorzystywania danych anonimowych lub stosowania plików
                        Cookie.
                    </p>
                </li>
                <li>
